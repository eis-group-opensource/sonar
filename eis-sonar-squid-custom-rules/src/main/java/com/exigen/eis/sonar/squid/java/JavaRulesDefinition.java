...
public class JavaRulesDefinition implements RulesDefinition {
	...
	private static final String RESOURCE_BASE_PATH = "/com/exigen/eis/l10n/java/rules/squid";

	public static final String REPOSITORY_KEY = "EIS";
	...
	public void define(Context context) {
		NewRepository repository = context.createRepository(REPOSITORY_KEY, "java").setName("EIS Sonar Squid Custom");
